# lumi.benchmark — Sub-processor List
...
A sub-processor is a third party that processes data on lumi's behalf (for
example, hosting, email delivery, or AI-generated analysis). lumi remains
accountable for any sub-processor's handling of data under the Data Sharing
Agreement (DPA).
...
Members who have accepted the DPA will be notified of additions to this list
in line with the DPA's change-notification terms.
