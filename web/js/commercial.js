    ...
    <div style=${{ maxWidth: "640px" }}>
      ...
      <div class="card" id="ai-insights" style=${{ padding: "var(--s5)", marginBottom: "var(--s4)" }}>
        ...
        <p class="caption">Short, written interpretations of <b>your own benchmark figures</b>, generated by AI —
          a description of your data, not advice. Your consent is separate and personal to you, and you can withdraw
          it at any time. <b style=${{ color: "var(--ink-faint)" }}>Draft terms — pending review.</b></p>
        ...
        ${ai.consented && !ai.master ? html`<div class="caption" style=${{ marginTop: "var(--s2)" }}>
          AI Insights aren't switched on across lumi yet (pending compliance review) — your choice is recorded
          and will apply when they go live.</div>` : null}
        <div class="caption" style=${{ marginTop: "var(--s2)" }}>
          Read the <a onClick=${e => { e.preventDefault(); setAiDoc(true); }} style=${{ cursor: "pointer" }}>AI Insights Terms (draft)</a>.</div>
      </div>
